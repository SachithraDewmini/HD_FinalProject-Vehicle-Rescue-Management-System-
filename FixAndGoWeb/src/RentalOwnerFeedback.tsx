...
const RentalOwnerFeedback: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-orange-100 via-orange-200 to-orange-300 py-10">
      <div className="container mx-auto">
        ...
        {feedbacks.length === 0 ? (
          <p className="text-center text-gray-700">No feedback available for this rentalowner.</p>
        ) : (
...
export default RentalOwnerFeedback;
