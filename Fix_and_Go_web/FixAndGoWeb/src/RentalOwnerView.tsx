          ...
          {rentalowners.map((rentalowner) => (
            <div key={rentalowner.id} className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600"><strong>Number of Seats:</strong> {Array.isArray(rentalowner.noOfsheets) ? rentalowner.noOfsheets.join(", ") : rentalowner.noOfsheets}</p>
